...
class PqrsfController
{
    ...
    public function postInsert()
    {
        ...
        if ($_POST['pqrsf_tipo_cod'] == 5) {
            $sql = "INSERT INTO t_pqrsf VALUES($id,$pqrsf_tipo_cod,NULL,2,'$pqrsf_nombres','$pqrsf_apellidos','$pqrsf_correo',NOW(),'$pqrsf_observacion')";
        } else {
            $sql = "INSERT INTO t_pqrsf VALUES($id,$pqrsf_tipo_cod,NULL,1,'$pqrsf_nombres','$pqrsf_apellidos','$pqrsf_correo',NOW(),'$pqrsf_observacion')";
        }
